...
module collections {
    ...
    */
    ...
    //     * internal node stores an _element such that the elements stored in the 
    ...
    //    /**
    //     * Adds the specified _element to this tree if it is not already present.
    //     * @param {Object} _element the _element to insert.
    //     * @return {boolean} true if this tree did not already contain the specified _element.
    //     */
    //    add(_element: T): boolean {
    //        if (collections.isUndefined(_element)) {
    //            return false;
    //        }

    //        if (this.insertNode(this.createNode(_element)) !== null) {
    //            this.nElements++;
    //            return true;
    //        }
    //        return false;
    ...
    //    /**
    //     * Returns true if this tree contains the specified _element.
    //     * @param {Object} _element _element to search for.
    //     * @return {boolean} true if this tree contains the specified _element,
    //     * false otherwise.
    //     */
    //    contains(_element: T): boolean {
    //        if (collections.isUndefined(_element)) {
    //            return false;
    //        }
    //        return this.searchNode(this.root, _element) !== null;
    //    }

    //    /**
    //     * Removes the specified _element from this tree if it is present.
    //     * @return {boolean} true if this tree contained the specified _element.
    //     */
    //    remove(_element: T): boolean {
    //        var node = this.searchNode(this.root, _element);
    //        if (node === null) {
    //            return false;
    //        }
    ...
    //    /**
    //     * Executes the provided function once for each _element present in this tree in 
    //     * in-order.
    //     * @param {function(Object):*} callback function to execute, it is invoked with one 
    //     * argument: the _element value, to break the iteration you can optionally return false.
    //     */
    ...
    //    /**
    //     * Executes the provided function once for each _element present in this tree in pre-order.
    //     * @param {function(Object):*} callback function to execute, it is invoked with one 
    //     * argument: the _element value, to break the iteration you can optionally return false.
    //     */
    ...
    //    /**
    //     * Executes the provided function once for each _element present in this tree in post-order.
    //     * @param {function(Object):*} callback function to execute, it is invoked with one 
    //     * argument: the _element value, to break the iteration you can optionally return false.
    //     */
    ...
    //    /**
    //     * Returns the minimum _element of this tree.
    //     * @return {*} the minimum _element of this tree or undefined if this tree is
    //     * is empty.
    //     */
    //    minimum(): T {
    //        if (this.isEmpty()) {
    //            return undefined;
    //        }
    //        return this.minimumAux(this.root)._element;
    //    }

    //    /**
    //     * Returns the maximum _element of this tree.
    //     * @return {*} the maximum _element of this tree or undefined if this tree is
    //     * is empty.
    //     */
    //    maximum(): T {
    //        if (this.isEmpty()) {
    //            return undefined;
    //        }
    //        return this.maximumAux(this.root)._element;
    //    }

    //    /**
    //     * Executes the provided function once for each _element present in this tree in inorder.
    ...
    //    toArray(): T[] {
    //        var array = [];
    //        this.inorderTraversal(function (_element: T): boolean {
    //            array.push(_element);
    //            return;
    //        });
    //        return array;
    ...
    //    * @private
    //    */
    //    private searchNode(node: BSTreeNode<T>, _element: T): BSTreeNode<T> {
    //        var cmp = null;
    //        while (node !== null && cmp !== 0) {
    //            cmp = this.compare(_element, node._element);
    //            if (cmp < 0) {
    //                node = node.leftCh;
    //            } else if (cmp > 0) {
    //                node = node.rightCh;
    ...
    //            return;
    //        }
    //        signal.stop = callback(node._element) === false;
    //        if (signal.stop) {
    //            return;
    //        }
    ...
    //        while (!queue.isEmpty()) {
    //            node = queue.dequeue();
    //            if (callback(node._element) === false) {
    //                return;
    //            }
    //            if (node.leftCh !== null) {
    ...
    //        var cmp = null;
    //        while (position !== null) {
    //            cmp = this.compare(node._element, position._element);
    //            if (cmp === 0) {
    //                return null;
    //            } else if (cmp < 0) {
    //                parent = position;
    ...
    //            // tree is empty
    //            this.root = node;
    //        } else if (this.compare(node._element, parent._element) < 0) {
    //            parent.leftCh = node;
    //        } else {
    //            parent.rightCh = node;
    //        }
    ...
    //    * @private
    //    */
    //    private createNode(_element: T): BSTreeNode<T> {
    //        return {
    //            _element: _element,
    //            leftCh: null,
    //            rightCh: null,
