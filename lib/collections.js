    ...
    */
    ...
    var LinkedList = (function () {
        ...
        */
        LinkedList.prototype.first = function () {
            if (this.firstNode !== null) {
                return this.firstNode._element;
            }
            return undefined;
        };
        /**
        ...
        */
        ...
        LinkedList.prototype.indexOf = function (item, equalsFunction) {
            ...
            while (currentNode !== null) {
                if (equalsF(currentNode._element, item)) {
                    return index;
                }
                index++;
        ...
        */
        ...
        LinkedList.prototype.removeElementAtIndex = function (index) {
            ...
            if (this.nElements === 1) {
                //First node in the list.
                element = this.firstNode._element;
                this.firstNode = null;
                this.lastNode = null;
            }
            else {
                ...
                if (previous === null) {
                    ...
                    element = this.lastNode._element;
                    this.lastNode = previous;
                }
                if (previous !== null) {
                    element = previous.next._element;
        ...
        LinkedList.prototype.forEach = function (callback) {
            var currentNode = this.firstNode;
            while (currentNode !== null) {
                if (callback(currentNode._element) === false) {
                    break;
                }
                currentNode = currentNode.next;
            }
        ...
        LinkedList.prototype.toArray = function () {
            ...
            var currentNode = this.firstNode;
            while (currentNode !== null) {
                array.push(currentNode._element);
                currentNode = currentNode.next;
            }
            return array;
        };
         ...
         */
        LinkedList.prototype._size = function () {
    ...
    var MultiDictionary = (function () {
        ...
        */
         ...
         * @return {number} the number of key-value mappings in this dictionary.
         */
        MultiDictionary.prototype._size = function () {
            return this.dict._size();
        };
        /**
         * Returns true if this dictionary contains no mappings.
         * @return {boolean} true if this dictionary contains no mappings.
    ...
    var Stack = (function () {
         ...
         */
        Stack.prototype._size = function () {
    ...
    var Queue = (function () {
         ...
         */
        Queue.prototype._size = function () {
            return this.list._size();
        };
        /**
    ...
    var PriorityQueue = (function () {
         ...
         */
        PriorityQueue.prototype._size = function () {
